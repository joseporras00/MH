...
def main():
    ...
    results.append([i,optimalOcurr, optimalOcurr/100,optimalOcurrLog, optimalOcurrLog/100,optimalOcurrGeo, optimalOcurrGeo/100])
        
    with open("SimAnnealingComp.csv", "w") as file:
        file.write(",".join(["N", "opt ocurr", "opt aver","Log opt ocurr","Log opt aver", "Geo opt ocurr","Geo opt aver"])+"\n")
    for res in results:
